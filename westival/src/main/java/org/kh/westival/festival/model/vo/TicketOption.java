...
public class TicketOption implements java.io.Serializable {
   ...
   public TicketOption(String ticket_no, String user_id, int no, String ticket_name, int ticket_price,
         int ticket_quantity, String company_name, String ceo_name, int company_no, String phone, String bank_name,
         String account_holder_name, int account_no, Date registration_date) {
      super();
