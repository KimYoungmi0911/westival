...
<div class="button intro_button" style="margin-left : 83%;"><div class="button_bcg"></div><a href="noticeview.do">목록<span></span><span></span><span></span></a></div>
<div style="float : right;">
<c:if test="${noticedetail.user_id eq 'admin' }">
	...
	if(confirm('정말로 삭제하시겠습니까 ? ') == true){
		...
		return;
						...
						<!-- <form action="#" id="contact_form" class="contact_form text-center">
							<input style="font-size : 22px;" type="text" id="contact_form_name" class="contact_form_name input_field" placeholder="Name" required="required" data-error="Name is required.">
