					...
					<div class="col main_nav_col d-flex flex-row align-items-center justify-content-start">
						...
						<div class="main_nav_container ml-auto">
							<ul class="main_nav_list">
								...
								<li class="main_nav_item"><a href="#">member</a></li>
								<li class="main_nav_item"><a href="#">festival</a></li>
								<li class="main_nav_item"><a href="#">reservation</a></li>
								<li class="main_nav_item"><a href="#">manage bulletins</a></li>								
							</ul>
						</div>
