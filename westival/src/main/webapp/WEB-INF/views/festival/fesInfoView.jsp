					...
					<div class="fesInfoview1">
						<div class="doc">
							...
							<div class="fesInfo detail">
								<div class="fes_image">
									<img src="/westival/resources/festivalUpImages/2561887.jpg">
								</div>
				...
				<div class="col">
					<div class="comment_frame">
						<form id="commentInsert" action="" method="post">
							...
							<input type="hidden" name="reply_user_id" value="user01">
		...
		$(function(){
			$.ajax({
				...
				success: function(obj){
					...
					if(obj.totalCount == 0){
						outValues += '<td colspan="2" class="center">등록된 메시지가 없습니다.</td>';
					}else{
